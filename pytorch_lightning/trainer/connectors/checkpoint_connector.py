...
from pytorch_lightning.utilities import _module_available, APEX_AVAILABLE, AMPType, OMEGACONF_AVAILABLE, rank_zero_info, rank_zero_warn
...
if OMEGACONF_AVAILABLE:
    ...
    if _module_available("omegaconf.Container"):
